...
from tensorflow.keras.callbacks import ModelCheckpoint, TensorBoard, ProgbarLogger
...
parser.add_argument('--log_dir', default='/home/saewon/Documents/tensorboard_outputs/perceptualCNN/super_res',
...
if __name__ == '__main__':
    ...
    filename = "perceptual-{epoch:02d}-{loss:.2f}.hdf5"
